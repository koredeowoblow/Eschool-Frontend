    ...
    <NotificationContext.Provider value={{ showNotification }}>
      ...
      <div className="fixed top-6 right-6 z-[10000] flex flex-col gap-3 w-full max-w-sm">
        {notifications.map(n => {
          ...
          return (
            <div key={n.id} className={`p-4 rounded-2xl border shadow-2xl flex items-center justify-between gap-4 glass-effect animate-in slide-in-from-right-10 fade-in duration-300 ${colors[n.type]}`}>
