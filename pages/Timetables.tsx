...
const Timetables: React.FC = () => {
  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-500">
                  ...
                  <tr key={time} className="h-32">
                    ...
                    {DAYS.map(day => {
                      ...
                      return (
                        ...
                        >
                          {session ? (
                            <div className={`p-3 rounded-xl h-full text-white shadow-sm transition-all hover:shadow-md ${getSubjectColor(session.subject?.name || 'Academic')}`}>
      ...
      <Modal isOpen={isModalOpen} onClose={() => setIsModalOpen(false)} title="Provision Schedule Slot">
